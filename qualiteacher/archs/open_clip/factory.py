...
def load_state_dict(checkpoint_path: str, map_location='cpu'):
    # weights_only=False for compatibility with PyTorch >= 2.6 (default flipped to True);
    # the DA-CLIP checkpoint stores numpy scalars that the weights-only unpickler rejects.
